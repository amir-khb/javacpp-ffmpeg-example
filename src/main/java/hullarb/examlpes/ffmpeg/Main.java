...
//        streamContexts = new Main.StreamContext[inputFormatContext.nb_streams()];
...
//            throw new RuntimeException("Failed to allocate output format context");
//        }
//
//        check(avformat_alloc_output_context2(outputFormatContext, null, null, fileName));
//
...
//            check(avio_open(ioContext, fileName, AVIO_FLAG_WRITE));
